...
<!-- Originally written in Spanish by the author (santifer). Translated to English for Olamide's deployment. -->

When the candidate pastes a job offer (text or URL), ALWAYS deliver the 6 blocks below in English.
